...
client = openrouteservice.Client(
    key='5b3ce3597851110001cf6248d4e646702ef148e5a55e272b239c23cb')  # Specify your personal API key
...
closest_metro = find_closest_metro_async(final_coords[0], final_coords[1], data)
print(
